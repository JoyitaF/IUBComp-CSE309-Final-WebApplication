...
<head>
    ...
    <title>Freeform Art Contest Submission</title>
...
<body>
    ...
    <form class="submitform" action="uploadart.php" method="post" enctype="multipart/form-data">

    <h3>Submit your photo to the Freeform Art Contest</h3>
        ...
        <label for="image_desc">Enter medium used for the art:</label>
        <input type="text" name="image_desc" id="image_desc"> <br>
        <button type="submit" name="submit">Upload</button>

        <h5 style="padding-top: 40px;">Check your submissions <a href="art_vote.php"> here. </a></h5>
    </form>
...
if(isset($_POST['submit'])) {
    ...
    $checkQuery = "SELECT id FROM free WHERE id = ?";
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $uploadedFile)) {
            ...
            $voteCount = 0;
            $insertQuery = "INSERT INTO free (id, image_url, fullName, email, image_desc, vote_count, datum) VALUES (?, ?, ?, ?, ?, ?, NOW())";
