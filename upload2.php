...
<head>
    ...
    <title>Street Photography Contest Submission</title>
...
<body>
    ...
    <form class="submitform" action="upload2.php" method="post" enctype="multipart/form-data">

    <h3>Submit your photo to the Street Photography Contest</h3>
        ...
        <h5 style="padding-top: 40px;">Check your submissions <a href="gallery_vote_2.php"> here. </a></h5>
    </form>
...
if(isset($_POST['submit'])) {
    ...
    $checkQuery = "SELECT id FROM street WHERE id = ?";
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $uploadedFile)) {
            ...
            $voteCount = 0;
            $insertQuery = "INSERT INTO street (id, image_url, fullName, email, image_desc, vote_count, datum) VALUES (?, ?, ?, ?, ?, ?, NOW())";
            ...
            // header("Location: gallery_vote_2.php");
