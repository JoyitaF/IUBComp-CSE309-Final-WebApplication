...
<header class="header">
   ...
   <h3 style="font-weight: bolder;">Black and White Photo Contest</h3>
   <h6>(Note: You can only vote once per picture)<h6><br>

   
   <h5 style="font-weight: bold;">To join the contest, submit your photo <a href="upload.php">here!</a></h5>
    <?php
