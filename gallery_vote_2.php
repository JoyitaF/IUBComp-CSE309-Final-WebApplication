...
<header class="header">
   ...
   <h3 style="font-weight: bolder;">Street Photography Contest</h3>
   <h6>(Note: You can only vote once per picture)<h6><br>

   
   <h5 style="font-weight: bold;">To join the contest, submit your photo <a href="upload2.php">here!</a></h5>
    <?php
    // Fetch images from the database
    $query = "SELECT id, fullName, image_url, image_desc FROM street";
